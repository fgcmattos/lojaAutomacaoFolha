...
Public Class FrmReciboConformidade
    Private Sub FrmReciboConformidade_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub BtnPesquisa_Click(sender As Object, e As EventArgs) Handles BtnPesquisa.Click
            ...
            If OpenDB() Then
                ...
                Try
                    ...
                    While DTReader.Read
                        ...
                        ListView1.Items(ListView1.Items.Count - 1).SubItems.Add(DTReader.GetString(8))          ' Tipo Descriocao
                ...
                If strValorTotal <> "0,00" Then
                    ...
                    'For Each lc As ColumnHeader In ListView2.Columns
                    '    lc.Width = -1
                    'Next

                    'ListBox1.Items.Add("T o t a l      " & strValorQTO & "    " & strValorTotal)
            ...
            ''MsgBox(strNumero)
            ''MsgBox(strFavorecido)
            ''MsgBox(strEmissao)
            ''MsgBox(strAssinatura)
            ''MsgBox(strValor)
            ''MsgBox(strDocumento)
            ''MsgBox(strHistorico)
            'MskNumero
