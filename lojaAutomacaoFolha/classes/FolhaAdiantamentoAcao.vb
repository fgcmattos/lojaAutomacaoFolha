...
Public Class FolhaAdiantamentoAcao

    Public Shared Function GetFolhaAdiantamento(strReferencia As String) As List(Of FolhaAdiantamento)

        Dim emp As List(Of empregador) = EmpregadorAcao.GetEmpregadorRescisao()

        Dim lista As New List(Of FolhaAdiantamento)
        ...
        Dim StrRef As String = strReferencia.Substring(4) & "/" & strReferencia.Substring(0, 4)
        ...
        Try
            If OpenDB() Then
                ...
                While DTReader.Read()
                    ...
                    {
                    .EmprCNPJ = CNPJcolocaMascara(emp(0).Cnpj),
                    .emprRazaoSocial = emp(0).RazaoSocial,
                    .EmprEndereco = Trim(emp(0).EnderecoCompleto),
                    .EmprCidade = emp(0).Municipio,
                    .ColChave = StrKeyCol,
                    ...
                    .emprHoleriteLocal = emp(0).holeriteLocal
                    }
                    )
        ...
        Catch ex As Exception
            ...
            MsgBox("Problemas Na Leitura da folhaAdiantamento!")
