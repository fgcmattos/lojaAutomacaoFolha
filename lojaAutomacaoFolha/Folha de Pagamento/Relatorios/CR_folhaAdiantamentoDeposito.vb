...
Public Class CR_folhaAdiantamentoDeposito
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CR_folhaAdiantamentoDeposito.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "lojaAutomacaoFolha.CR_folhaAdiantamentoDeposito.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_dataImpressao() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_extenso() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCR_folhaAdiantamentoDeposito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_folhaAdiantamentoDeposito = New CR_folhaAdiantamentoDeposito()
        rpt.Site = Me.Site
        Return rpt
    End Function
