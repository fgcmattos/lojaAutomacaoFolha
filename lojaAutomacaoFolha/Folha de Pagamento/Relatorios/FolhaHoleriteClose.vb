...
Public Class FolhaHoleriteClose
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "lojaAutomacaoFolha.FolhaHoleriteClose.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IDcab() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedFolhaHoleriteClose
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FolhaHoleriteClose = New FolhaHoleriteClose()
        rpt.Site = Me.Site
        Return rpt
    End Function
